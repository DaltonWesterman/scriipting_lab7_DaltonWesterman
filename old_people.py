...
def get_old_people():
    ...
    cur.execute('SELECT name, SELECT age FROM people WHERE age >= 50')
...
def print_name_and_age(name_and_age_list):
    ...
    for old_people in old_people:
        print(f"{name_and_age_list} years old")
    return
...
def save_name_and_age_to_csv(name_and_age_list, csv_path):
    ...
    df.to_csv('old_people_name/age.csv', index=True)
